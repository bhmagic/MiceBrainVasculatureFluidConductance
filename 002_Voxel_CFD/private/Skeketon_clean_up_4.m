function [S_skel,S_radii,length_node_to_remove_par] = Skeketon_clean_up_4(S_skel, S_radii,CropSize,Judging_length)
...
if Judging_length>10
    parfor ii = 1:length(wierdNode_group.name)
        node_to_remove_par{ii} = graph_clean_4(wierdNode_in_name_par{ii},wierdNode_out_name_par{ii},link_table_wierd_full_par{ii});
    end
